...
{
    public class DeerAvoidBorderState : DeerState
    {
        private readonly Transform _pursuer;

        private readonly Vector2 _fleeDirection;
        
        public DeerAvoidBorderState(AnimalInfo animalInfo, Transform pursuer) : base(animalInfo)
        {
            _pursuer = pursuer;
        ...
        public override void Update()
        {
            ...
            {
                ChangeAnimalState(new DeerFleeState(AnimalInfo, _pursuer));
                return;
            }
